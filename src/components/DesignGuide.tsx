...
export default function DesignGuide() {
  ...
  const SECTIONS: GuideSection[] = useMemo(() => [
      ...
      content: (
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="py-16 px-10 rounded-xl bg-white border border-zinc-200 dark:bg-zinc-900 dark:border-transparent flex flex-col items-center justify-center gap-6">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400 text-center max-w-sm leading-relaxed">
                {t(
                  <>&apos;a&apos;와 &apos;o&apos;는 같은 원형(Node)을 공유합니다.<br />&apos;x&apos;의 무한대 곡선과 &apos;w&apos;의 꺾임이 Flow의 방향성을 반복합니다.<br />전체 워드마크가 하나의 Graph 구조를 형성합니다.</>,
                  <>&apos;a&apos; and &apos;o&apos; share the same circular Node shape.<br />The infinity curve of &apos;x&apos; and the angular bend of &apos;w&apos; repeat the directionality of Flow.<br />The entire wordmark forms a single Graph structure.</>
                )}
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col justify-center gap-5">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex gap-3">
                    ...
                    <p className="text-sm dark:text-zinc-300"><strong>Node (a, o)</strong> — {t("'a'의 counter와 'o'의 원형이 동일한 Graph Node를 반복합니다. 데이터의 핵심 단위.", "The counter of 'a' and the circle of 'o' repeat the same Graph Node. The core unit of data.")}</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-2.5 h-2.5 rounded-full mt-1.5 shrink-0" style={{ backgroundColor: "#6F36FF" }} />
                    <p className="text-sm dark:text-zinc-300"><strong>Edge (stems, crossbars)</strong> — {t("'a'의 stem, 'f'의 crossbar, 'l'의 수직선이 Node를 연결하는 Edge입니다.", "The stem of 'a', crossbar of 'f', and vertical stroke of 'l' form the Edges connecting Nodes.")}</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-2.5 h-2.5 rounded-full mt-1.5 shrink-0" style={{ backgroundColor: "#444CE7" }} />
                    <p className="text-sm dark:text-zinc-300"><strong>Flow (x, w)</strong> — {t("'x'의 교차와 'w'의 꺾임이 데이터의 방향성과 흐름을 표현합니다.", "The intersection of 'x' and the angular bend of 'w' express the directionality and flow of data.")}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">{t("로고 주변에 최소 로고 높이의 1.5배 여백을 확보해야 합니다.", "A minimum clear space of 1.5x the logo height must be maintained around the logo.")}</p>
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                ...
                <div className="text-center">
                  ...
                  <p className="text-[10px] text-zinc-400">{t("권장", "Recommended")}</p>
                </div>
              </div>
              <div className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                ...
                <div className="text-center">
                  ...
                  <p className="text-[10px] text-zinc-400">{t("표준", "Standard")}</p>
                </div>
              </div>
              <div className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                ...
                <div className="text-center">
                  ...
                  <p className="text-[10px] text-zinc-400">{t("최소", "Minimum")}</p>
                </div>
              </div>
              <div className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl border dark:border-zinc-700" style={{ backgroundColor: "rgba(240, 68, 56, 0.05)", borderColor: "rgba(240, 68, 56, 0.15)" }}>
                ...
                <div className="text-center">
                  ...
                  <p className="text-[10px]" style={{ color: "#F04438", opacity: 0.7 }}>{t("사용 금지", "Prohibited")}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="p-4 rounded-xl border" style={{ backgroundColor: "rgba(21, 183, 158, 0.06)", borderColor: "rgba(21, 183, 158, 0.2)" }}>
                  ...
                  <div className="flex flex-col gap-2 text-sm text-zinc-800 dark:text-zinc-200">
                    <p>{t("로고 높이 1.5배 여백 확보", "Maintain 1.5x logo height clear space")}</p>
                    <p>{t("단색은 Black / White만 사용", "Use only Black / White for monochrome")}</p>
                    <p>{t("원본 비율 유지", "Maintain original proportions")}</p>
                    <p>{t("공식 배포 파일만 사용", "Use only officially distributed files")}</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="p-4 rounded-xl border" style={{ backgroundColor: "rgba(240, 68, 56, 0.06)", borderColor: "rgba(240, 68, 56, 0.2)" }}>
                  ...
                  <div className="flex flex-col gap-2 text-sm text-zinc-800 dark:text-zinc-200">
                    <p>{t("비율 왜곡 금지", "Do not distort proportions")}</p>
                    <p>{t("지정 외 컬러 적용 금지", "Do not apply unauthorized colors")}</p>
                    <p>{t("그림자 / 3D 효과 금지", "No shadows / 3D effects")}</p>
                    <p>{t("복잡한 배경 위 사용 금지", "Do not use over complex backgrounds")}</p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-3 rounded-lg border flex items-center justify-center h-24 relative" style={{ backgroundColor: "rgba(240, 68, 56, 0.04)", borderColor: "rgba(240, 68, 56, 0.15)" }}>
                    ...
                    <span className="absolute bottom-1 text-[9px]" style={{ color: "#F04438" }}>{t("비율 왜곡", "Distorted")}</span>
                  </div>
                  <div className="p-3 rounded-lg border flex items-center justify-center h-24 relative" style={{ backgroundColor: "rgba(240, 68, 56, 0.04)", borderColor: "rgba(240, 68, 56, 0.15)" }}>
                    ...
                    <span className="absolute bottom-1 text-[9px]" style={{ color: "#F04438" }}>{t("지정 외 컬러", "Wrong color")}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      content: (
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">{t("브랜딩에는 White, Black, 그레이스케일 그라데이션만 사용합니다.", "Only White, Black, and grayscale gradients are used for branding.")}</p>
          ...
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">{t("포인트 컬러는 최소한으로, 브랜드 강조가 필요한 곳에만 보수적으로 사용합니다. CTA, 핵심 인터랙션, 브랜딩 비주얼에 한정합니다.", "Point colors should be used sparingly and conservatively, only where brand emphasis is needed. Limited to CTAs, key interactions, and branding visuals.")}</p>
            <div className="grid grid-cols-3 gap-4">
              <div className="flex flex-col items-center gap-2">
            ...
            <div className="mt-4 p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
              <p className="text-xs font-medium mb-2">{t("사용 원칙", "Usage Principles")}</p>
              <ul className="text-[11px] text-zinc-500 dark:text-zinc-400 flex flex-col gap-1.5">
                <li>{t("UI 전체에 사용하지 않습니다. Neutral 팔레트가 기본입니다.", "Do not use across the entire UI. The Neutral palette is the default.")}</li>
                <li>{t("CTA 버튼, 주요 액션, 활성 상태 등 강조가 필요한 곳에만 사용합니다.", "Use only where emphasis is needed: CTA buttons, primary actions, active states.")}</li>
                <li>{t("한 화면에 포인트 컬러는 1~2곳 이내로 제한합니다.", "Limit point color usage to 1-2 spots per screen.")}</li>
                <li>{t("그라데이션은 브랜딩 비주얼, 히어로 영역에만 사용합니다.", "Gradients are used only for branding visuals and hero sections.")}</li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">{t("UI에 사용되는 Neutral 팔레트. 12단계 그레이스케일로 구성됩니다.", "The Neutral palette used in the UI. Composed of a 12-step grayscale.")}</p>
          ...
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">{t("브랜드 강조에 사용되는 포인트 컬러. CTA, 핵심 인터랙션에 한정하여 보수적으로 사용합니다.", "Point colors used for brand emphasis. Used conservatively, limited to CTAs and key interactions.")}</p>
          ...
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">{t("상태 표시에 사용되는 시맨틱 컬러. 각 상태에 600(강조)과 100(배경) 쌍으로 구성됩니다.", "Semantic colors used for status indicators. Each status consists of a 600 (emphasis) and 100 (background) pair.")}</p>
            <div className="grid grid-cols-4 gap-4">
              {[
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400">{t("N900 — 본문, 제목 등 주요 텍스트", "N900 — Body text, headings, and primary text")}</p>
              </div>
              <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400">{t("N600 — 보조 텍스트, 아이콘", "N600 — Secondary text, icons")}</p>
              </div>
              <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400">{t("N400 — 비활성 텍스트, 플레이스홀더", "N400 — Disabled text, placeholders")}</p>
              </div>
              <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400">{t("N200 — 테두리, 구분선", "N200 — Borders, dividers")}</p>
              </div>
              <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <div className="flex items-center gap-2 mb-2">
      ...
      content: (
        <div className="flex flex-col gap-6">
          <div className="py-12 px-10 rounded-xl bg-zinc-900 flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-sm text-zinc-400 text-center">{t("제조 산업을 위한 AI 운영 체제. axflow의 핵심 포지셔닝을 한 문장으로 전달합니다.", "An AI operating system for manufacturing. Communicates axflow's core positioning in a single sentence.")}</p>
          </div>
        </div>
      ),
    },
      ...
      content: (
        <div className="flex flex-col gap-6">
          <div className="p-4 rounded-lg bg-zinc-50 border border-zinc-200 dark:bg-zinc-800 dark:border-zinc-700 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <p><strong>Outfit</strong> — {t("브랜딩 전용 (로고, 슬로건, 마케팅 비주얼). 한글 미지원.", "Branding only (logo, slogan, marketing visuals). No Korean support.")}</p>
            <p><strong>Pretendard</strong> — {t("UI 전체 (Headline, Title, Label, Body). 한영 혼합 지원.", "All UI (Headline, Title, Label, Body). Supports Korean and English.")}</p>
          </div>
          <div className="grid grid-cols-2 gap-6">
            <div>
              <h5 className="text-xs font-medium text-zinc-500 uppercase mb-1">Branding — Outfit</h5>
              <p className="text-sm text-zinc-500 mb-3">{t("로고, 슬로건, 마케팅 비주얼에만 사용. 영문/숫자 전용.", "Used only for logos, slogans, and marketing visuals. English/numbers only.")}</p>
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 mb-3">{t("Headline, Title, Label, Body 전체. 한영 혼합 최적화.", "All Headline, Title, Label, and Body. Optimized for mixed Korean/English.")}</p>
              <div className="flex flex-col gap-2">
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-4">
          <p className="text-sm text-zinc-600 dark:text-zinc-400">{t("Node/Edge/Flow 컨셉에서 추출한 비주얼 패턴. 명함, PPT, 웹사이트, 앱 아이콘 등에 활용합니다.", "Visual patterns derived from the Node/Edge/Flow concept. Used for business cards, presentations, websites, app icons, and more.")}</p>
          <div className="grid grid-cols-2 gap-4">
            {/* Orbital Nodes */}
            <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{t("동심원 구조의 레이어드 데이터 표현. 명함, PPT 배경에 활용.", "Layered data representation in concentric circles. Used for business cards and presentation backgrounds.")}</p>
            </div>
            {/* Stream Lines */}
            <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
              <div className="w-full h-36 rounded-lg mb-3 flex items-center justify-center overflow-hidden bg-zinc-900">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{t("수평 엣지와 흐르는 노드. 웹사이트 히어로, 배너에 활용.", "Horizontal edges with flowing nodes. Used for website heroes and banners.")}</p>
            </div>
            {/* Process Grid */}
            <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
              <div className="w-full h-36 rounded-lg mb-3 flex items-center justify-center overflow-hidden bg-zinc-900">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{t("제조 워크플로우 추상화. 로딩 화면, 대시보드 배경에 활용.", "Abstract manufacturing workflow. Used for loading screens and dashboard backgrounds.")}</p>
            </div>
            {/* Hub Radial */}
            <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
              <div className="w-full h-36 rounded-lg mb-3 flex items-center justify-center overflow-hidden bg-zinc-900">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{t("중심 허브에서 방사형으로 확장. 파비콘, 앱 아이콘에 활용.", "Radial expansion from a central hub. Used for favicons and app icons.")}</p>
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-3">
            {[
              { title: "Confident, Not Arrogant", desc: t("팩트 기반 메시징. 과장하지 않는다.", "Fact-based messaging. No exaggeration.") },
              { title: "Clear, Not Simple", desc: t("기술적 신뢰를 유지하면서 명확하게.", "Clear while maintaining technical credibility.") },
              { title: "Human, Not Casual", desc: t("공감하되 전문적으로.", "Empathetic yet professional.") },
              { title: "Forward, Not Hype", desc: t("결과에 기반한 비전 제시.", "Vision grounded in results.") },
            ].map((item) => (
              <div key={item.title} className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <p className="font-medium text-sm dark:text-zinc-200">{item.title}</p>
                <p className="text-xs text-zinc-500 mt-1 dark:text-zinc-400">{item.desc}</p>
              </div>
            ))}
          </div>
          <div className="mt-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-4 rounded-xl border" style={{ backgroundColor: "rgba(21, 183, 158, 0.08)", borderColor: "rgba(21, 183, 158, 0.2)" }}>
                ...
                <p className="text-sm text-zinc-800 dark:text-zinc-200">{t('"배치 문서화 시간을 3시간에서 20분으로 단축합니다."', '"Reduce batch documentation time from 3 hours to 20 minutes."')}</p>
              </div>
              <div className="p-4 rounded-xl border" style={{ backgroundColor: "rgba(240, 68, 56, 0.06)", borderColor: "rgba(240, 68, 56, 0.2)" }}>
                <p className="text-xs font-medium mb-2" style={{ color: "#F04438" }}>DON&apos;T</p>
                <p className="text-sm text-zinc-800 dark:text-zinc-200">{t('"혁신적인 AI로 모든 것을 바꿉니다."', '"Our innovative AI changes everything."')}</p>
              </div>
            </div>
          </div>
        </div>
